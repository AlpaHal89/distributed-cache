...
public class TestCache {
    ...
    public void setUp() {
        ...
        dataSource = new DataSource<>() {
            ...
            @Override
            public CompletableFuture<Void> persist(String key, String value, long timestamp) {
    ...
    public void RaceConditions() throws ExecutionException, InterruptedException {
        ...
        final CompletableFuture<List<String>> results = CompletableFuture.allOf(futures.toArray(CompletableFuture[]::new))
    ...
    private boolean isEqualTo(CompletableFuture<String> future, String value) {
